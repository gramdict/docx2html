...
//            ConvertMainDictionary();
        ...
        static string GetFullestSymbolsRegex()
        {
            ...
            string[] symbols =
                "ф.,мо⁺,жо⁺,м,мо,ж,жо,с,со,жо,мо-жо,мн.,мн. _от_,п,мс,мс-п,числ.,числ.-п,св,нсв,св-нсв,св/нсв,н,част.,част.(_усилительная_),союз,предл.,предик.,вводн.,межд.,сравн.,§1,§2,предикативное мс,_см._"
                    .Split(',')
